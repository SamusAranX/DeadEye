...
namespace DeadEye.Helpers {
	public enum AutostartStatus {
		...
		[Description("Disabled in the Task Manager")] Disabled,
	...
	internal class AutostartHelper {
		...
		/// </summary>
		/// <returns>A Tuple of AutostartStatus and (if explicitly disabled) a DateTime object representing the date and time at which autostart was disabled in the Task Manager.</returns>
